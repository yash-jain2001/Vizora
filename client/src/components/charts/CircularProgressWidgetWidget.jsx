...
const CircularProgressWidgetWidget = ({ title = 'Circular Progress Widget' }) => {
  ...
  const option = useWidgetData('circular-progress-widget', initialOption);
...
export default CircularProgressWidgetWidget;