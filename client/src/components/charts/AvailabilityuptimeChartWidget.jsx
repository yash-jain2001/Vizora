...
const AvailabilityuptimeChartWidget = ({ title = 'Availability/Uptime Chart' }) => {
  ...
  const option = useWidgetData('availabilityuptime-chart', initialOption);
...
export default AvailabilityuptimeChartWidget;