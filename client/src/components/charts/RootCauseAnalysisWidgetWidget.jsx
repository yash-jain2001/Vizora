...
const RootCauseAnalysisWidgetWidget = ({ title = 'Root Cause Analysis Widget' }) => {
  ...
  const option = useWidgetData('root-cause-analysis-widget', initialOption);
...
export default RootCauseAnalysisWidgetWidget;