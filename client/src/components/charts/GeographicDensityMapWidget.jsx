...
const GeographicDensityMapWidget = ({ title = 'Geographic Density Map' }) => {
  ...
  const option = useWidgetData('geographic-density-map', initialOption);
...
export default GeographicDensityMapWidget;