...
const ParallelCoordinatesPlotWidget = ({ title = 'Parallel Coordinates Plot' }) => {
  const option = { parallelAxis: [ { dim: 0, name: 'Price', nameTextStyle: {color:'#fff'} }, { dim: 1, name: 'Weight', nameTextStyle: {color:'#fff'} } ], parallel: { left: '5%', right: '15%', bottom: '10%', top: '20%' }, series: { type: 'parallel', lineStyle: { width: 2, color: '#f59e0b', opacity: 0.5 }, data: [ [12.99, 100], [9.99, 80] ] } };
