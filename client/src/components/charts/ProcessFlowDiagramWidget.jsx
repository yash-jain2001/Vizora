...
const ProcessFlowDiagramWidget = ({ title = 'Process Flow Diagram' }) => {
  ...
  const option = useWidgetData('process-flow-diagram', initialOption);
...
export default ProcessFlowDiagramWidget;