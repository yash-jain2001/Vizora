...
const ForceDirectedGraphWidget = ({ title = 'Force Directed Graph' }) => {
  ...
  const option = useWidgetData('force-directed-graph', initialOption);
...
export default ForceDirectedGraphWidget;