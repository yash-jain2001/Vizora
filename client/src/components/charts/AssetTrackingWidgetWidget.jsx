...
const AssetTrackingWidgetWidget = ({ title = 'Asset Tracking Widget' }) => {
  ...
  const option = useWidgetData('asset-tracking-widget', initialOption);
...
export default AssetTrackingWidgetWidget;