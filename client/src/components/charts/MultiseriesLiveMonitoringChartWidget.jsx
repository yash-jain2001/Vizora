...
const MultiseriesLiveMonitoringChartWidget = ({ title = 'Multi-Series Live Monitoring Chart' }) => {
  ...
  const option = useWidgetData('multiseries-live-monitoring-chart', initialOption);
...
export default MultiseriesLiveMonitoringChartWidget;