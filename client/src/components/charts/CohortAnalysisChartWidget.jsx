...
const CohortAnalysisChartWidget = ({ title = 'Cohort Analysis Chart' }) => {
  ...
  const option = useWidgetData('cohort-analysis-chart', initialOption);
...
export default CohortAnalysisChartWidget;