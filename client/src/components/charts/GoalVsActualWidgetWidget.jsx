...
const GoalVsActualWidgetWidget = ({ title = 'Goal vs Actual Widget' }) => {
  ...
  const option = useWidgetData('goal-vs-actual-widget', initialOption);
...
export default GoalVsActualWidgetWidget;