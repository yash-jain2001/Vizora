...
const MetricComparisonWidgetWidget = ({ title = 'Metric Comparison Widget' }) => {
  ...
  const option = useWidgetData('metric-comparison-widget', initialOption);
...
export default MetricComparisonWidgetWidget;