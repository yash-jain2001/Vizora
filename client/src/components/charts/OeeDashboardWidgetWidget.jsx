...
const OeeDashboardWidgetWidget = ({ title = 'OEE Dashboard Widget' }) => {
  ...
  const option = useWidgetData('oee-dashboard-widget', initialOption);
...
export default OeeDashboardWidgetWidget;