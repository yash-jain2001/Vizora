...
const AnomalyDetectionChartWidget = ({ title = 'Anomaly Detection Chart' }) => {
  ...
  const option = useWidgetData('anomaly-detection-chart', initialOption);
...
export default AnomalyDetectionChartWidget;