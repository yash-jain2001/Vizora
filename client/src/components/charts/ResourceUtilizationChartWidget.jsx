...
const ResourceUtilizationChartWidget = ({ title = 'Resource Utilization Chart' }) => {
  ...
  const option = useWidgetData('resource-utilization-chart', initialOption);
...
export default ResourceUtilizationChartWidget;