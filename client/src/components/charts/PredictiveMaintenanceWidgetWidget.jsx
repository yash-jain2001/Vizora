...
const PredictiveMaintenanceWidgetWidget = ({ title = 'Predictive Maintenance Widget' }) => {
  return (
    <div className="w-full h-full flex flex-col pt-3 pb-4 px-4 relative bg-brand-card/45">
      ...
      <div className="w-full h-full flex flex-col items-center justify-center p-4">
        <div className="text-slate-400 text-center">
          ...
          <p className="font-semibold text-sm text-white">Predictive Maintenance Widget</p>
...
export default PredictiveMaintenanceWidgetWidget;