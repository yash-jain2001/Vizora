...
const TopnRankingChartWidget = ({ title = 'Top-N Ranking Chart' }) => {
  ...
  const option = useWidgetData('topn-ranking-chart', initialOption);
...
export default TopnRankingChartWidget;