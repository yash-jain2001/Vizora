...
const PopulationPyramidWidget = ({ title = 'Population Pyramid' }) => {
  ...
  const option = useWidgetData('population-pyramid', initialOption);
...
export default PopulationPyramidWidget;