...
const CapacityPlanningChartWidget = ({ title = 'Capacity Planning Chart' }) => {
  ...
  const option = useWidgetData('capacity-planning-chart', initialOption);
...
export default CapacityPlanningChartWidget;