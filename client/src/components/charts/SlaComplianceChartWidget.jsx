...
const SlaComplianceChartWidget = ({ title = 'SLA Compliance Chart' }) => {
  ...
  const option = useWidgetData('sla-compliance-chart', initialOption);
...
export default SlaComplianceChartWidget;