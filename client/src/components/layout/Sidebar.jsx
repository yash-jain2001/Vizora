      ...
      <div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <NavLink to="/alerts" className={getLinkClass}>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a9.04 9.04 0 01-2.937 1.248c-.07.03-.15.03-.22 0a9.032 9.032 0 01-2.937-1.248M15.75 9a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25z" />
            </svg>
            Alerts
          </NavLink>
